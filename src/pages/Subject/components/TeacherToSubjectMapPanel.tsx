...
const TeacherToSubjectMapPanel = ({openPanelForTeacherToSubjectMap,setOpenPanelForTeacherToSubjectMap,teacherToSubjectMapData,handleOnDeleteTeacherSubjectChoice}:any) => {
  ...
  return (
    ...
    >
      ...
      <div className="border-b p-4">
            ...
            <Button variant={'default'}>Download Excel file</Button>
            </div>
          </div>
                                            ...
                                            if(stream.subjects.length > 0 ){
                                                return (
                                                    <ul className="mt-4 border px-2 py-2 rounded-sm">
                                                        <h3 className="mb-2 font-semibold">{stream.stream_name}</h3>
                                                        {stream.subjects.map(
