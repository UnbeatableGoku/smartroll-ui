import type { SubjectToTeacherMap, TeacherToSubjectMap } from '@/types/common'
  ...
  reducers: {
    updateSubjectAllocationState: (
      ...
      action: PayloadAction<{
        SubjectToTeacherAllocation: SubjectToTeacherMap
        status: string | null
        error: string | null
        isDataLoaded: boolean
        TeacherToSubjectAllocation: TeacherToSubjectMap[]
      }>,
    ) => {
      return {
        ...state,
...
} = subjectAllocationSlice.actions
